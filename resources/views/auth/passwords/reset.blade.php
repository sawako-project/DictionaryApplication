...
<div class="heading">
   <h2><strong><span class="under">パスワードリセット</span></strong></h2>
</div>
                ...
                @endif
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="m-form-text @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
