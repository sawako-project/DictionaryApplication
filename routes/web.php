...
//表現の検索結果
Route::get('/search_phrases','PhraseSearchController@search')->name("search.result");
...
Route::group(['middleware' => ['auth']], function(){
   ...
   //ログインネームの変更
   Route::get('/user/reset/name/','User\UserInfoController@nameEdit')->name("user_name.edit");
   ...
   //退会する
   Route::get('/user/info/delete/','User\UserInfoController@delete_confirm')->name("user_info.delete_confirm");
...
Route::group(['middleware' => ['auth.admin']], function () {
   ...
   Route::get('/admin/phrase/show/{id}', 'Admin\AdminPhraseController@show')->name("admin.phrase.show");
